...
export interface GeneratedServiceClientCtor<T extends ServiceDefinition> {
    service: T;
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions>): Client;
}
...
export declare type SessionConfig = OAuthCredentialsConfig | IamTokenCredentialsConfig | ServiceAccountCredentialsConfig | GenericCredentialsConfig;
export declare type WrappedServiceClientType<S extends ServiceDefinition> = RawClient<NormalizedServiceDefinition<S>, DeadlineOptions & RetryOptions>;
