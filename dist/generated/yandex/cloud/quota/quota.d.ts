...
export declare const QuotaFailure: {
    ...
    fromPartial<I extends {
        ...
        violations?: ({
            ...
            required?: number | undefined;
        } & Record<Exclude<keyof I["violations"][number], "$type" | "metric" | "required">, never>)[] & Record<Exclude<keyof I["violations"], "$type" | keyof {
            metric?: {
                name?: string | undefined;
                limit?: number | undefined;
                usage?: number | undefined;
...
export declare const QuotaFailure_Violation: {
    ...
    fromPartial<I extends {
        ...
        required?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "metric" | "required">, never>>(object: I): QuotaFailure_Violation;
};
