...
export declare const DnsZone: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "id" | "createdAt" | "folderId" | "name" | "labels" | "zone" | "privateVisibility" | "publicVisibility">, never>>(object: I): DnsZone;
};
...
export declare const RecordSet: {
    ...
    fromPartial<I extends {
        ...
        name?: string | undefined;
        ttl?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "type" | "data" | "name" | "ttl">, never>>(object: I): RecordSet;
};
