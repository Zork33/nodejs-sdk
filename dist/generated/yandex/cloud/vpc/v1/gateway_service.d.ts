...
export declare const ListGatewaysResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["gateways"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "name" | "labels" | "sharedEgressGateway">, never>)[] & Record<Exclude<keyof I["gateways"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const CreateGatewayRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "sharedEgressGatewaySpec">, never>>(object: I): CreateGatewayRequest;
};
