...
export declare const Origin: {
    ...
    } & Record<Exclude<keyof I, "$type" | "id" | "originGroupId" | "source" | "enabled" | "backup" | "meta">, never>>(object: I): Origin;
};
export declare const OriginParams: {
    ...
    } & Record<Exclude<keyof I, "$type" | "source" | "enabled" | "backup" | "meta">, never>>(object: I): OriginParams;
};
