...
export declare const ListMembersResponse: {
    ...
    fromPartial<I extends {
        ...
        users?: ({
            ...
            } & Record<Exclude<keyof I["users"][number]["subjectClaims"], "$type" | "sub" | "name" | "email" | "givenName" | "familyName" | "preferredUsername" | "picture" | "zoneinfo" | "locale" | "phoneNumber" | "federation">, never>) | undefined;
...
export declare const ListMembersResponse_OrganizationUser: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["subjectClaims"], "$type" | "sub" | "name" | "email" | "givenName" | "familyName" | "preferredUsername" | "picture" | "zoneinfo" | "locale" | "phoneNumber" | "federation">, never>) | undefined;
