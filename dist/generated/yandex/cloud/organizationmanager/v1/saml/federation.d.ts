...
export declare const Federation: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "id" | "createdAt" | "name" | "labels" | "issuer" | "organizationId" | "autoCreateAccountOnLogin" | "ssoBinding" | "ssoUrl" | "caseInsensitiveNameIds" | "cookieMaxAge" | "securitySettings">, never>>(object: I): Federation;
};
...
export declare const FederationSecuritySettings: {
    ...
    fromPartial<I extends {
        ...
        encryptedAssertions?: boolean | undefined;
    } & Record<Exclude<keyof I, "$type" | "encryptedAssertions">, never>>(object: I): FederationSecuritySettings;
};
