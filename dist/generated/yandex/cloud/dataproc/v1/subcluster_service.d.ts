...
export declare const ListSubclustersResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["subclusters"][number], "$type" | "id" | "createdAt" | "name" | "role" | "subnetId" | "resources" | "instanceGroupId" | "clusterId" | "hostsCount" | "assignPublicIp" | "autoscalingConfig">, never>)[] & Record<Exclude<keyof I["subclusters"], "$type" | keyof {
            id?: string | undefined;
            createdAt?: Date | undefined;
            name?: string | undefined;
            role?: Role | undefined;
