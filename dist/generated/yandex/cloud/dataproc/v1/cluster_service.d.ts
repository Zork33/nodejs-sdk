...
export declare const ListClustersResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["clusters"][number], "$type" | "description" | "id" | "createdAt" | "config" | "folderId" | "status" | "name" | "labels" | "bucket" | "logGroupId" | "securityGroupIds" | "zoneId" | "deletionProtection" | "serviceAccountId" | "health" | "uiProxy" | "hostGroupIds" | "monitoring">, never>)[] & Record<Exclude<keyof I["clusters"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            config?: {
...
export declare const CreateClusterRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "bucket" | "logGroupId" | "securityGroupIds" | "zoneId" | "deletionProtection" | "serviceAccountId" | "uiProxy" | "hostGroupIds" | "configSpec">, never>>(object: I): CreateClusterRequest;
};
...
export declare const ListClusterHostsResponse: {
    ...
    fromPartial<I extends {
        ...
        hosts?: ({
            ...
            subclusterId?: string | undefined;
            computeInstanceId?: string | undefined;
        } & Record<Exclude<keyof I["hosts"][number], "$type" | "name" | "role" | "health" | "subclusterId" | "computeInstanceId">, never>)[] & Record<Exclude<keyof I["hosts"], "$type" | keyof {
            name?: string | undefined;
            role?: Role | undefined;
            health?: import("../../../../yandex/cloud/dataproc/v1/common").Health | undefined;
            subclusterId?: string | undefined;
