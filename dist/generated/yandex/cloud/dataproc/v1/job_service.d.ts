...
export declare const ListJobsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["jobs"][number], "$type" | "id" | "createdBy" | "createdAt" | "status" | "name" | "clusterId" | "startedAt" | "finishedAt" | "mapreduceJob" | "sparkJob" | "pysparkJob" | "hiveJob" | "applicationInfo">, never>)[] & Record<Exclude<keyof I["jobs"], "$type" | keyof {
            id?: string | undefined;
            createdBy?: string | undefined;
            createdAt?: Date | undefined;
            status?: import("../../../../yandex/cloud/dataproc/v1/job").Job_Status | undefined;
