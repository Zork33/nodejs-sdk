...
export declare const Parameter: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "text" | "name" | "title" | "hidden" | "labelValues" | "custom" | "integerParameter" | "doubleParameter" | "textValues">, never>>(object: I): Parameter;
};
export declare const Parametrization: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["parameters"][number], "$type" | "description" | "text" | "name" | "title" | "hidden" | "labelValues" | "custom" | "integerParameter" | "doubleParameter" | "textValues">, never>)[] & Record<Exclude<keyof I["parameters"], "$type" | keyof {
            description?: string | undefined;
            text?: {
                defaultValue?: string | undefined;
            } | undefined;
