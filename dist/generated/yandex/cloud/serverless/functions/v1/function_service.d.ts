...
import { Resources, Connectivity, Function, Version, Package, Secret, ScalingPolicy } from "../../../../../yandex/cloud/serverless/functions/v1/function";
...
export declare const CreateFunctionRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels">, never>>(object: I): CreateFunctionRequest;
};
...
export declare const ListFunctionsVersionsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["versions"][number], "$type" | "description" | "id" | "createdAt" | "status" | "logGroupId" | "resources" | "serviceAccountId" | "tags" | "secrets" | "environment" | "connectivity" | "executionTimeout" | "functionId" | "runtime" | "entrypoint" | "imageSize" | "namedServiceAccounts">, never>)[] & Record<Exclude<keyof I["versions"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            status?: import("../../../../../yandex/cloud/serverless/functions/v1/function").Version_Status | undefined;
...
export declare const CreateFunctionVersionRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "content" | "resources" | "versionId" | "serviceAccountId" | "package" | "secrets" | "environment" | "connectivity" | "executionTimeout" | "functionId" | "runtime" | "entrypoint" | "namedServiceAccounts" | "tag">, never>>(object: I): CreateFunctionVersionRequest;
};
...
export declare const ListScalingPoliciesResponse: {
    ...
    fromPartial<I extends {
        ...
        scalingPolicies?: ({
            ...
            zoneInstancesLimit?: number | undefined;
            zoneRequestsLimit?: number | undefined;
        } & Record<Exclude<keyof I["scalingPolicies"][number], "$type" | "createdAt" | "modifiedAt" | "functionId" | "tag" | "provisionedInstancesCount" | "zoneInstancesLimit" | "zoneRequestsLimit">, never>)[] & Record<Exclude<keyof I["scalingPolicies"], "$type" | keyof {
            createdAt?: Date | undefined;
            modifiedAt?: Date | undefined;
            functionId?: string | undefined;
            tag?: string | undefined;
...
export declare const SetScalingPolicyRequest: {
    ...
    fromPartial<I extends {
        ...
        zoneInstancesLimit?: number | undefined;
        zoneRequestsLimit?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "functionId" | "tag" | "provisionedInstancesCount" | "zoneInstancesLimit" | "zoneRequestsLimit">, never>>(object: I): SetScalingPolicyRequest;
};
