...
export declare const ListProxyResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["proxies"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "name" | "labels" | "target">, never>)[] & Record<Exclude<keyof I["proxies"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const CreateProxyRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "target">, never>>(object: I): CreateProxyRequest;
};
