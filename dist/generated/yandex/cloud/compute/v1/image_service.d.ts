...
export declare const GetImageLatestByFamilyRequest: {
    ...
    fromPartial<I extends {
        ...
        folderId?: string | undefined;
        family?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "folderId" | "family">, never>>(object: I): GetImageLatestByFamilyRequest;
};
export declare const ListImagesRequest: {
    ...
    fromPartial<I extends {
        ...
        filter?: string | undefined;
        folderId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "filter" | "folderId">, never>>(object: I): ListImagesRequest;
};
export declare const ListImagesResponse: {
    ...
    fromPartial<I extends {
        ...
        images?: {
            ...
            folderId?: string | undefined;
            status?: import("../../../../yandex/cloud/compute/v1/image").Image_Status | undefined;
            ...
            minDiskSize?: number | undefined;
            pooled?: boolean | undefined;
            os?: {
                type?: import("../../../../yandex/cloud/compute/v1/image").Os_Type | undefined;
            } | undefined;
        }[] | undefined;
    } & {
        nextPageToken?: string | undefined;
        images?: ({
            ...
            labels?: ({
                ...
                [x: string]: string | undefined;
                [x: number]: string | undefined;
            } & Record<Exclude<keyof I["images"][number]["labels"], string | number>, never>) | undefined;
            productIds?: (string[] & string[] & Record<Exclude<keyof I["images"][number]["productIds"], "$type" | keyof string[]>, never>) | undefined;
            family?: string | undefined;
            storageSize?: number | undefined;
            minDiskSize?: number | undefined;
            pooled?: boolean | undefined;
            os?: ({
                ...
                type?: import("../../../../yandex/cloud/compute/v1/image").Os_Type | undefined;
            } & Record<Exclude<keyof I["images"][number]["os"], "$type" | "type">, never>) | undefined;
        } & Record<Exclude<keyof I["images"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "productIds" | "family" | "storageSize" | "minDiskSize" | "pooled" | "os">, never>)[] & Record<Exclude<keyof I["images"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const CreateImageRequest: {
    ...
    fromPartial<I extends {
        ...
        os?: ({
            ...
            type?: import("../../../../yandex/cloud/compute/v1/image").Os_Type | undefined;
        } & Record<Exclude<keyof I["os"], "$type" | "type">, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "uri" | "name" | "labels" | "productIds" | "diskId" | "imageId" | "snapshotId" | "family" | "minDiskSize" | "pooled" | "os">, never>>(object: I): CreateImageRequest;
};
export declare const CreateImageRequest_LabelsEntry: {
    ...
    fromPartial<I extends {
        ...
        value?: string | undefined;
        key?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "value" | "key">, never>>(object: I): CreateImageRequest_LabelsEntry;
};
export declare const CreateImageMetadata: {
    ...
    fromPartial<I extends {
        ...
        imageId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "imageId">, never>>(object: I): CreateImageMetadata;
};
export declare const UpdateImageRequest: {
    ...
    fromPartial<I extends {
        ...
        imageId?: string | undefined;
        minDiskSize?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "name" | "labels" | "updateMask" | "imageId" | "minDiskSize">, never>>(object: I): UpdateImageRequest;
};
export declare const UpdateImageRequest_LabelsEntry: {
    ...
    fromPartial<I extends {
        ...
        value?: string | undefined;
        key?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "value" | "key">, never>>(object: I): UpdateImageRequest_LabelsEntry;
};
export declare const UpdateImageMetadata: {
    ...
    fromPartial<I extends {
        ...
        imageId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "imageId">, never>>(object: I): UpdateImageMetadata;
};
...
export declare const ListImageOperationsRequest: {
    ...
    fromPartial<I extends {
        ...
        pageToken?: string | undefined;
        imageId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "imageId">, never>>(object: I): ListImageOperationsRequest;
};
export declare const ListImageOperationsResponse: {
    ...
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "operations">, never>>(object: I): ListImageOperationsResponse;
};
