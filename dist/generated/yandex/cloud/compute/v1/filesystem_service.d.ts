...
export declare const ListFilesystemsRequest: {
    ...
    fromPartial<I extends {
        ...
        filter?: string | undefined;
        folderId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "filter" | "folderId">, never>>(object: I): ListFilesystemsRequest;
};
export declare const ListFilesystemsResponse: {
    ...
    fromPartial<I extends {
        ...
        filesystems?: ({
            ...
            size?: number | undefined;
            blockSize?: number | undefined;
        } & Record<Exclude<keyof I["filesystems"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "zoneId" | "typeId" | "size" | "blockSize">, never>)[] & Record<Exclude<keyof I["filesystems"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const CreateFilesystemRequest: {
    ...
    fromPartial<I extends {
        ...
        size?: number | undefined;
        blockSize?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "zoneId" | "typeId" | "size" | "blockSize">, never>>(object: I): CreateFilesystemRequest;
};
