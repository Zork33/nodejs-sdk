...
import { MetadataOptions, SchedulingPolicy, NetworkSettings, PlacementPolicy, IpVersion, Instance } from "../../../../yandex/cloud/compute/v1/instance";
...
export declare const ListInstancesRequest: {
    ...
    fromPartial<I extends {
        ...
        filter?: string | undefined;
        folderId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "filter" | "folderId">, never>>(object: I): ListInstancesRequest;
};
export declare const ListInstancesResponse: {
    ...
    fromPartial<I extends {
        ...
        instances?: ({
            ...
            } & Record<Exclude<keyof I["instances"][number]["placementPolicy"], "$type" | "placementGroupId" | "hostAffinityRules">, never>) | undefined;
        } & Record<Exclude<keyof I["instances"][number], "$type" | "description" | "id" | "createdAt" | "metadata" | "folderId" | "status" | "name" | "labels" | "zoneId" | "resources" | "filesystems" | "platformId" | "fqdn" | "serviceAccountId" | "metadataOptions" | "bootDisk" | "secondaryDisks" | "localDisks" | "networkInterfaces" | "schedulingPolicy" | "networkSettings" | "placementPolicy">, never>)[] & Record<Exclude<keyof I["instances"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            metadata?: {
...
export declare const CreateInstanceRequest: {
        ...
        bootDiskSpec?: ({
            ...
            diskSpec?: ({
                ...
                diskPlacementPolicy?: ({
                    ...
                    placementGroupId?: string | undefined;
                } & Record<Exclude<keyof I["bootDiskSpec"]["diskSpec"]["diskPlacementPolicy"], "$type" | "placementGroupId">, never>) | undefined;
                imageId?: string | undefined;
                snapshotId?: string | undefined;
            } & Record<Exclude<keyof I["bootDiskSpec"]["diskSpec"], "$type" | "description" | "name" | "typeId" | "size" | "blockSize" | "diskPlacementPolicy" | "imageId" | "snapshotId">, never>) | undefined;
        ...
        secondaryDiskSpecs?: ({
            ...
            diskSpec?: ({
                ...
                diskPlacementPolicy?: ({
                    ...
                    placementGroupId?: string | undefined;
                } & Record<Exclude<keyof I["secondaryDiskSpecs"][number]["diskSpec"]["diskPlacementPolicy"], "$type" | "placementGroupId">, never>) | undefined;
                imageId?: string | undefined;
                snapshotId?: string | undefined;
            } & Record<Exclude<keyof I["secondaryDiskSpecs"][number]["diskSpec"], "$type" | "description" | "name" | "typeId" | "size" | "blockSize" | "diskPlacementPolicy" | "imageId" | "snapshotId">, never>) | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "metadata" | "folderId" | "name" | "labels" | "zoneId" | "platformId" | "serviceAccountId" | "metadataOptions" | "schedulingPolicy" | "networkSettings" | "placementPolicy" | "hostname" | "resourcesSpec" | "bootDiskSpec" | "secondaryDiskSpecs" | "localDiskSpecs" | "filesystemSpecs" | "networkInterfaceSpecs">, never>>(object: I): CreateInstanceRequest;
};
...
export declare const UpdateInstanceRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "metadata" | "name" | "labels" | "updateMask" | "platformId" | "serviceAccountId" | "metadataOptions" | "schedulingPolicy" | "networkSettings" | "placementPolicy" | "instanceId" | "resourcesSpec">, never>>(object: I): UpdateInstanceRequest;
};
        ...
        attachedDiskSpec?: ({
            ...
            diskSpec?: ({
                ...
                diskPlacementPolicy?: ({
                    ...
                    placementGroupId?: string | undefined;
                } & Record<Exclude<keyof I["attachedDiskSpec"]["diskSpec"]["diskPlacementPolicy"], "$type" | "placementGroupId">, never>) | undefined;
                imageId?: string | undefined;
                snapshotId?: string | undefined;
            } & Record<Exclude<keyof I["attachedDiskSpec"]["diskSpec"], "$type" | "description" | "name" | "typeId" | "size" | "blockSize" | "diskPlacementPolicy" | "imageId" | "snapshotId">, never>) | undefined;
    ...
    fromPartial<I extends {
        ...
        diskSpec?: ({
            ...
            diskPlacementPolicy?: ({
                ...
                placementGroupId?: string | undefined;
            } & Record<Exclude<keyof I["diskSpec"]["diskPlacementPolicy"], "$type" | "placementGroupId">, never>) | undefined;
            imageId?: string | undefined;
            snapshotId?: string | undefined;
        } & Record<Exclude<keyof I["diskSpec"], "$type" | "description" | "name" | "typeId" | "size" | "blockSize" | "diskPlacementPolicy" | "imageId" | "snapshotId">, never>) | undefined;
...
export declare const AttachedDiskSpec_DiskSpec: {
    ...
    fromPartial<I extends {
        ...
        diskPlacementPolicy?: ({
            ...
            placementGroupId?: string | undefined;
        } & Record<Exclude<keyof I["diskPlacementPolicy"], "$type" | "placementGroupId">, never>) | undefined;
        imageId?: string | undefined;
        snapshotId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "name" | "typeId" | "size" | "blockSize" | "diskPlacementPolicy" | "imageId" | "snapshotId">, never>>(object: I): AttachedDiskSpec_DiskSpec;
};
