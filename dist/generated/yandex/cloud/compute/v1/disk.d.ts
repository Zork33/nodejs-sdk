...
export declare const Disk: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "zoneId" | "typeId" | "size" | "blockSize" | "productIds" | "instanceIds" | "sourceImageId" | "sourceSnapshotId" | "diskPlacementPolicy">, never>>(object: I): Disk;
};
...
export declare const DiskPlacementPolicy: {
    ...
    fromPartial<I extends {
        ...
        placementGroupId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "placementGroupId">, never>>(object: I): DiskPlacementPolicy;
};
