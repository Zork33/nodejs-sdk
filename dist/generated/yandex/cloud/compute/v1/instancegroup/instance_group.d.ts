...
export declare const AllocationPolicy: {
    ...
    fromPartial<I extends {
        ...
        zones?: ({
            ...
            zoneId?: string | undefined;
        } & Record<Exclude<keyof I["zones"][number], "$type" | "zoneId">, never>)[] & Record<Exclude<keyof I["zones"], "$type" | keyof {
            zoneId?: string | undefined;
        }[]>, never>) | undefined;
...
export declare const AllocationPolicy_Zone: {
    ...
    fromPartial<I extends {
        ...
        zoneId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "zoneId">, never>>(object: I): AllocationPolicy_Zone;
};
export declare const InstanceTemplate: {
    ...
    fromPartial<I extends {
        ...
        bootDiskSpec?: ({
            ...
            diskSpec?: ({
                ...
                snapshotId?: string | undefined;
                preserveAfterInstanceDelete?: boolean | undefined;
            } & Record<Exclude<keyof I["bootDiskSpec"]["diskSpec"], "$type" | "description" | "typeId" | "size" | "imageId" | "snapshotId" | "preserveAfterInstanceDelete">, never>) | undefined;
        } & Record<Exclude<keyof I["bootDiskSpec"], "$type" | "mode" | "diskId" | "deviceName" | "diskSpec">, never>) | undefined;
        secondaryDiskSpecs?: ({
            mode?: AttachedDiskSpec_Mode | undefined;
            diskId?: string | undefined;
            deviceName?: string | undefined;
            ...
            diskSpec?: ({
                ...
                snapshotId?: string | undefined;
                preserveAfterInstanceDelete?: boolean | undefined;
            } & Record<Exclude<keyof I["secondaryDiskSpecs"][number]["diskSpec"], "$type" | "description" | "typeId" | "size" | "imageId" | "snapshotId" | "preserveAfterInstanceDelete">, never>) | undefined;
        } & Record<Exclude<keyof I["secondaryDiskSpecs"][number], "$type" | "mode" | "diskId" | "deviceName" | "diskSpec">, never>)[] & Record<Exclude<keyof I["secondaryDiskSpecs"], "$type" | keyof {
            mode?: AttachedDiskSpec_Mode | undefined;
            diskId?: string | undefined;
            deviceName?: string | undefined;
            diskSpec?: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "metadata" | "name" | "labels" | "platformId" | "serviceAccountId" | "schedulingPolicy" | "networkSettings" | "placementPolicy" | "hostname" | "resourcesSpec" | "bootDiskSpec" | "secondaryDiskSpecs" | "networkInterfaceSpecs">, never>>(object: I): InstanceTemplate;
};
...
export declare const AttachedDiskSpec: {
    ...
    fromPartial<I extends {
        ...
        diskSpec?: ({
            ...
            snapshotId?: string | undefined;
            preserveAfterInstanceDelete?: boolean | undefined;
        } & Record<Exclude<keyof I["diskSpec"], "$type" | "description" | "typeId" | "size" | "imageId" | "snapshotId" | "preserveAfterInstanceDelete">, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "mode" | "diskId" | "deviceName" | "diskSpec">, never>>(object: I): AttachedDiskSpec;
};
export declare const AttachedDiskSpec_DiskSpec: {
    ...
    fromPartial<I extends {
        ...
        snapshotId?: string | undefined;
        preserveAfterInstanceDelete?: boolean | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "typeId" | "size" | "imageId" | "snapshotId" | "preserveAfterInstanceDelete">, never>>(object: I): AttachedDiskSpec_DiskSpec;
};
...
export declare const LoadBalancerSpec: {
    ...
    } & Record<Exclude<keyof I, "$type" | "targetGroupSpec" | "maxOpeningTrafficDuration">, never>>(object: I): LoadBalancerSpec;
};
...
export declare const ApplicationLoadBalancerSpec: {
    ...
    } & Record<Exclude<keyof I, "$type" | "targetGroupSpec" | "maxOpeningTrafficDuration">, never>>(object: I): ApplicationLoadBalancerSpec;
};
...
export declare const ManagedInstance: {
    ...
    fromPartial<I extends {
        ...
        statusMessage?: string | undefined;
        statusChangedAt?: Date | undefined;
    } & Record<Exclude<keyof I, "$type" | "id" | "status" | "name" | "zoneId" | "fqdn" | "networkInterfaces" | "instanceId" | "statusMessage" | "statusChangedAt">, never>>(object: I): ManagedInstance;
};
