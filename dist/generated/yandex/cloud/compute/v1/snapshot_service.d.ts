...
export declare const ListSnapshotsRequest: {
    ...
    fromPartial<I extends {
        ...
        filter?: string | undefined;
        folderId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "filter" | "folderId">, never>>(object: I): ListSnapshotsRequest;
};
...
export declare const CreateSnapshotRequest: {
    ...
    fromPartial<I extends {
        ...
        diskId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "diskId">, never>>(object: I): CreateSnapshotRequest;
};
