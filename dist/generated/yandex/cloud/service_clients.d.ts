...
export declare const ProjectServiceClient: {
    ...
    service: {
        ...
        readonly getNotebookMetadata: {
            ...
            readonly requestStream: false;
            readonly responseStream: false;
            readonly requestSerialize: (value: cloudApi.datasphere.project_service.GetNotebookMetadataRequest) => Buffer;
            readonly requestDeserialize: (value: Buffer) => cloudApi.datasphere.project_service.GetNotebookMetadataRequest;
            readonly responseSerialize: (value: cloudApi.datasphere.project_service.GetNotebookMetadataResponse) => Buffer;
            readonly responseDeserialize: (value: Buffer) => cloudApi.datasphere.project_service.GetNotebookMetadataResponse;
        };
    };
};
