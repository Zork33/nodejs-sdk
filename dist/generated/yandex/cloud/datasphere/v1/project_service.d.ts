...
export declare const CreateProjectRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "settings" | "limits">, never>>(object: I): CreateProjectRequest;
};
...
export declare const UpdateProjectRequest: {
    ...
    fromPartial<I extends {
        ...
        projectId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "name" | "updateMask" | "settings" | "limits" | "projectId">, never>>(object: I): UpdateProjectRequest;
};
...
export declare const ListProjectsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["projects"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "name" | "settings" | "limits">, never>)[] & Record<Exclude<keyof I["projects"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
