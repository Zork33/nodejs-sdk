...
export declare const ListLifecyclePoliciesResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["lifecyclePolicies"][number], "$type" | "description" | "id" | "createdAt" | "status" | "name" | "repositoryId" | "rules">, never>)[] & Record<Exclude<keyof I["lifecyclePolicies"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            status?: LifecyclePolicy_Status | undefined;
...
export declare const CreateLifecyclePolicyRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "status" | "name" | "repositoryId" | "rules">, never>>(object: I): CreateLifecyclePolicyRequest;
};
export declare const UpdateLifecyclePolicyRequest: {
    ...
    fromPartial<I extends {
        ...
        lifecyclePolicyId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "status" | "name" | "updateMask" | "rules" | "lifecyclePolicyId">, never>>(object: I): UpdateLifecyclePolicyRequest;
};
...
export declare const ListDryRunLifecyclePolicyResultAffectedImagesResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["affectedImages"][number], "$type" | "id" | "createdAt" | "config" | "name" | "digest" | "compressedSize" | "tags" | "layers">, never>)[] & Record<Exclude<keyof I["affectedImages"], "$type" | keyof {
            id?: string | undefined;
            createdAt?: Date | undefined;
            config?: {
                id?: string | undefined;
