...
export declare const ListRegistriesResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["registries"][number], "$type" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels">, never>)[] & Record<Exclude<keyof I["registries"], "$type" | keyof {
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
            status?: import("../../../../yandex/cloud/containerregistry/v1/registry").Registry_Status | undefined;
...
export declare const CreateRegistryRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "folderId" | "name" | "labels">, never>>(object: I): CreateRegistryRequest;
};
