...
import { BillableObject, BillableObjectBinding } from "../../../../yandex/cloud/billing/v1/billable_object";
...
export declare const GetBillingAccountRequest: {
    ...
    fromPartial<I extends {
        ...
        id?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "id">, never>>(object: I): GetBillingAccountRequest;
};
export declare const ListBillingAccountsRequest: {
    ...
    fromPartial<I extends {
        ...
        pageSize?: number | undefined;
        pageToken?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken">, never>>(object: I): ListBillingAccountsRequest;
};
export declare const ListBillingAccountsResponse: {
    ...
    fromPartial<I extends {
        ...
        billingAccounts?: ({
            ...
            active?: boolean | undefined;
            balance?: string | undefined;
        } & Record<Exclude<keyof I["billingAccounts"][number], "$type" | "id" | "createdAt" | "name" | "countryCode" | "currency" | "active" | "balance">, never>)[] & Record<Exclude<keyof I["billingAccounts"], "$type" | keyof {
            id?: string | undefined;
            createdAt?: Date | undefined;
            name?: string | undefined;
            countryCode?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "billingAccounts">, never>>(object: I): ListBillingAccountsResponse;
};
export declare const ListBillableObjectBindingsRequest: {
    ...
    fromPartial<I extends {
        ...
        pageToken?: string | undefined;
        billingAccountId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "billingAccountId">, never>>(object: I): ListBillableObjectBindingsRequest;
};
export declare const ListBillableObjectBindingsResponse: {
    ...
    fromPartial<I extends {
        ...
        billableObjectBindings?: ({
            ...
            billableObject?: ({
                ...
                id?: string | undefined;
                type?: string | undefined;
            } & Record<Exclude<keyof I["billableObjectBindings"][number]["billableObject"], "$type" | "id" | "type">, never>) | undefined;
        } & Record<Exclude<keyof I["billableObjectBindings"][number], "$type" | "effectiveTime" | "billableObject">, never>)[] & Record<Exclude<keyof I["billableObjectBindings"], "$type" | keyof {
            effectiveTime?: Date | undefined;
            billableObject?: {
                id?: string | undefined;
                type?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "billableObjectBindings">, never>>(object: I): ListBillableObjectBindingsResponse;
};
export declare const BindBillableObjectRequest: {
    ...
    fromPartial<I extends {
        ...
        billingAccountId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "billableObject" | "billingAccountId">, never>>(object: I): BindBillableObjectRequest;
};
export declare const BindBillableObjectMetadata: {
    ...
    fromPartial<I extends {
        billableObjectId?: string | undefined;
    } & {
        billableObjectId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "billableObjectId">, never>>(object: I): BindBillableObjectMetadata;
};
...
export declare const BillingAccountServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): BillingAccountServiceClient;
