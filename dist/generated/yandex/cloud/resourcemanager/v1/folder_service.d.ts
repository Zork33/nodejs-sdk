...
export declare const ListFoldersResponse: {
    ...
    fromPartial<I extends {
        ...
        folders?: ({
            ...
            cloudId?: string | undefined;
        } & Record<Exclude<keyof I["folders"][number], "$type" | "description" | "id" | "createdAt" | "status" | "name" | "labels" | "cloudId">, never>)[] & Record<Exclude<keyof I["folders"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            status?: import("../../../../yandex/cloud/resourcemanager/v1/folder").Folder_Status | undefined;
...
export declare const UpdateFolderRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "updateMask">, never>>(object: I): UpdateFolderRequest;
};
