...
import { AnonymousAccessFlags, ACL, WebsiteSettings, Versioning, Bucket, CorsRule, LifecycleRule, BucketStats, HTTPSConfig } from "../../../../yandex/cloud/storage/v1/bucket";
...
export declare const ListBucketsResponse: {
    ...
    fromPartial<I extends {
        ...
        buckets?: ({
            ...
            lifecycleRules?: ({
                ...
                filter?: ({
                    ...
                    prefix?: string | undefined;
                } & Record<Exclude<keyof I["buckets"][number]["lifecycleRules"][number]["filter"], "$type" | "prefix">, never>) | undefined;
                enabled?: boolean | undefined;
                expiration?: ({
                    days?: number | undefined;
                    date?: Date | undefined;
        ...
        } & Record<Exclude<keyof I["buckets"][number], "$type" | "id" | "createdAt" | "folderId" | "name" | "cors" | "maxSize" | "policy" | "defaultStorageClass" | "versioning" | "anonymousAccessFlags" | "acl" | "websiteSettings" | "lifecycleRules">, never>)[] & Record<Exclude<keyof I["buckets"], "$type" | keyof {
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
            name?: string | undefined;
...
export declare const CreateBucketRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "folderId" | "name" | "maxSize" | "defaultStorageClass" | "anonymousAccessFlags" | "acl">, never>>(object: I): CreateBucketRequest;
};
    ...
    fromPartial<I extends {
        ...
        lifecycleRules?: ({
            ...
            filter?: ({
                ...
                prefix?: string | undefined;
            } & Record<Exclude<keyof I["lifecycleRules"][number]["filter"], "$type" | "prefix">, never>) | undefined;
            enabled?: boolean | undefined;
            expiration?: ({
                days?: number | undefined;
                date?: Date | undefined;
        ...
        fieldMask?: ({
            ...
            paths?: (string[] & string[] & Record<Exclude<keyof I["fieldMask"]["paths"], "$type" | keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["fieldMask"], "$type" | "paths">, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "name" | "cors" | "maxSize" | "policy" | "defaultStorageClass" | "versioning" | "anonymousAccessFlags" | "acl" | "websiteSettings" | "lifecycleRules" | "fieldMask">, never>>(object: I): UpdateBucketRequest;
};
