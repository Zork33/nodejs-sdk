...
exports.UpdateBucketRequest = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.fieldMask !== undefined) {
            field_mask_1.FieldMask.encode(message.fieldMask, writer.uint32(18).fork()).ldelim();
        }
        if (message.anonymousAccessFlags !== undefined) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.fieldMask = field_mask_1.FieldMask.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.anonymousAccessFlags = bucket_1.AnonymousAccessFlags.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        message.fieldMask =
            object.fieldMask !== undefined && object.fieldMask !== null
                ? field_mask_1.FieldMask.fromJSON(object.fieldMask)
                : undefined;
        message.anonymousAccessFlags =
            object.anonymousAccessFlags !== undefined &&
                object.anonymousAccessFlags !== null
    ...
    toJSON(message) {
        ...
        message.fieldMask !== undefined &&
            (obj.fieldMask = message.fieldMask
                ? field_mask_1.FieldMask.toJSON(message.fieldMask)
                : undefined);
        message.anonymousAccessFlags !== undefined &&
            (obj.anonymousAccessFlags = message.anonymousAccessFlags
                ? bucket_1.AnonymousAccessFlags.toJSON(message.anonymousAccessFlags)
    ...
    fromPartial(object) {
        ...
        message.fieldMask =
            object.fieldMask !== undefined && object.fieldMask !== null
                ? field_mask_1.FieldMask.fromPartial(object.fieldMask)
                : undefined;
        message.anonymousAccessFlags =
            object.anonymousAccessFlags !== undefined &&
                object.anonymousAccessFlags !== null
