...
export declare const Hints: {
    ...
    fromPartial<I extends {
        ...
        volume?: number | undefined;
        role?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "voice" | "audioTemplate" | "speed" | "volume" | "role">, never>>(object: I): Hints;
};
export declare const UtteranceSynthesisRequest: {
    ...
    fromPartial<I extends {
        ...
        hints?: ({
            ...
            volume?: number | undefined;
            role?: string | undefined;
        } & Record<Exclude<keyof I["hints"][number], "$type" | "voice" | "audioTemplate" | "speed" | "volume" | "role">, never>)[] & Record<Exclude<keyof I["hints"], "$type" | keyof {
            voice?: string | undefined;
            audioTemplate?: {
                audio?: {
                    content?: Buffer | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "model" | "text" | "textTemplate" | "loudnessNormalizationType" | "unsafeMode" | "hints" | "outputAudioSpec">, never>>(object: I): UtteranceSynthesisRequest;
};
