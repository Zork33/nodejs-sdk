...
export declare const TranslateRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "folderId" | "model" | "sourceLanguageCode" | "targetLanguageCode" | "format" | "texts" | "speller" | "glossaryConfig">, never>>(object: I): TranslateRequest;
};
...
export declare const DetectLanguageRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "folderId" | "text" | "languageCodeHints">, never>>(object: I): DetectLanguageRequest;
};
...
export declare const ListLanguagesResponse: {
    ...
    fromPartial<I extends {
        ...
        languages?: ({
            ...
            code?: string | undefined;
            name?: string | undefined;
        } & Record<Exclude<keyof I["languages"][number], "$type" | "code" | "name">, never>)[] & Record<Exclude<keyof I["languages"], "$type" | keyof {
            code?: string | undefined;
            name?: string | undefined;
        }[]>, never>) | undefined;
