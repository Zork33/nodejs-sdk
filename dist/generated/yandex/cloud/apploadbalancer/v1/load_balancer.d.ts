...
export declare const LoadBalancer: {
        ...
        listeners?: ({
            ...
            http?: ({
                ...
                handler?: ({
                    ...
                    allowHttp10?: boolean | undefined;
                } & Record<Exclude<keyof I["listeners"][number]["http"]["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                redirects?: ({
                    httpToHttps?: boolean | undefined;
                } & {
                    httpToHttps?: boolean | undefined;
            ...
            tls?: ({
                ...
                defaultHandler?: ({
                    ...
                    httpHandler?: ({
                        ...
                        allowHttp10?: boolean | undefined;
                    } & Record<Exclude<keyof I["listeners"][number]["tls"]["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                    streamHandler?: ({
                        backendGroupId?: string | undefined;
                    } & {
                        backendGroupId?: string | undefined;
                ...
                sniHandlers?: ({
                    ...
                    handler?: ({
                        ...
                        httpHandler?: ({
                            ...
                            allowHttp10?: boolean | undefined;
                        } & Record<Exclude<keyof I["listeners"][number]["tls"]["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                        streamHandler?: ({
                            backendGroupId?: string | undefined;
                        } & {
                            backendGroupId?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "regionId" | "networkId" | "logGroupId" | "securityGroupIds" | "listeners" | "allocationPolicy">, never>>(object: I): LoadBalancer;
};
...
export declare const HttpListener: {
    ...
    fromPartial<I extends {
        ...
        handler?: ({
            ...
            allowHttp10?: boolean | undefined;
        } & Record<Exclude<keyof I["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
        redirects?: ({
            httpToHttps?: boolean | undefined;
        } & {
            httpToHttps?: boolean | undefined;
    ...
    fromPartial<I extends {
        ...
        defaultHandler?: ({
            ...
            httpHandler?: ({
                ...
                allowHttp10?: boolean | undefined;
            } & Record<Exclude<keyof I["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
            streamHandler?: ({
                backendGroupId?: string | undefined;
            } & {
                backendGroupId?: string | undefined;
        ...
        sniHandlers?: ({
            ...
            handler?: ({
                ...
                httpHandler?: ({
                    ...
                    allowHttp10?: boolean | undefined;
                } & Record<Exclude<keyof I["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                streamHandler?: ({
                    backendGroupId?: string | undefined;
                } & {
                    backendGroupId?: string | undefined;
...
export declare const HttpHandler: {
    ...
    fromPartial<I extends {
        ...
        allowHttp10?: boolean | undefined;
    } & Record<Exclude<keyof I, "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>>(object: I): HttpHandler;
};
...
export declare const TlsHandler: {
    ...
    fromPartial<I extends {
        ...
        httpHandler?: ({
            ...
            allowHttp10?: boolean | undefined;
        } & Record<Exclude<keyof I["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
        streamHandler?: ({
            backendGroupId?: string | undefined;
        } & {
            backendGroupId?: string | undefined;
