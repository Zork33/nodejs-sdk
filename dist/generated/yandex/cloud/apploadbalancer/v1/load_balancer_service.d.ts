...
import { AllocationPolicy, TlsHandler, LoadBalancer, HttpListener, TlsListener, StreamListener, TargetState } from "../../../../yandex/cloud/apploadbalancer/v1/load_balancer";
...
export declare const ListLoadBalancersResponse: {
    ...
    fromPartial<I extends {
            ...
            listeners?: ({
                ...
                http?: ({
                    ...
                    handler?: ({
                        ...
                        allowHttp10?: boolean | undefined;
                    } & Record<Exclude<keyof I["loadBalancers"][number]["listeners"][number]["http"]["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                    redirects?: ({
                        httpToHttps?: boolean | undefined;
                    } & {
                        httpToHttps?: boolean | undefined;
                ...
                tls?: ({
                    ...
                    defaultHandler?: ({
                        ...
                        httpHandler?: ({
                            ...
                            allowHttp10?: boolean | undefined;
                        } & Record<Exclude<keyof I["loadBalancers"][number]["listeners"][number]["tls"]["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                        streamHandler?: ({
                            backendGroupId?: string | undefined;
                        } & {
                            backendGroupId?: string | undefined;
                    ...
                    sniHandlers?: ({
                        ...
                        handler?: ({
                            ...
                            httpHandler?: ({
                                ...
                                allowHttp10?: boolean | undefined;
                            } & Record<Exclude<keyof I["loadBalancers"][number]["listeners"][number]["tls"]["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                            streamHandler?: ({
                                backendGroupId?: string | undefined;
                            } & {
                                backendGroupId?: string | undefined;
        ...
        } & Record<Exclude<keyof I["loadBalancers"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "regionId" | "networkId" | "logGroupId" | "securityGroupIds" | "listeners" | "allocationPolicy">, never>)[] & Record<Exclude<keyof I["loadBalancers"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const UpdateLoadBalancerRequest: {
        ...
        listenerSpecs?: ({
            ...
            http?: ({
                ...
                handler?: ({
                    ...
                    allowHttp10?: boolean | undefined;
                } & Record<Exclude<keyof I["listenerSpecs"][number]["http"]["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                redirects?: ({
                    httpToHttps?: boolean | undefined;
                } & {
                    httpToHttps?: boolean | undefined;
            ...
            tls?: ({
                ...
                defaultHandler?: ({
                    ...
                    httpHandler?: ({
                        ...
                        allowHttp10?: boolean | undefined;
                    } & Record<Exclude<keyof I["listenerSpecs"][number]["tls"]["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                    streamHandler?: ({
                        backendGroupId?: string | undefined;
                    } & {
                        backendGroupId?: string | undefined;
                ...
                sniHandlers?: ({
                    ...
                    handler?: ({
                        ...
                        httpHandler?: ({
                            ...
                            allowHttp10?: boolean | undefined;
                        } & Record<Exclude<keyof I["listenerSpecs"][number]["tls"]["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                        streamHandler?: ({
                            backendGroupId?: string | undefined;
                        } & {
                            backendGroupId?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "name" | "labels" | "updateMask" | "securityGroupIds" | "allocationPolicy" | "loadBalancerId" | "listenerSpecs">, never>>(object: I): UpdateLoadBalancerRequest;
};
...
export declare const CreateLoadBalancerRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "regionId" | "networkId" | "securityGroupIds" | "allocationPolicy" | "listenerSpecs">, never>>(object: I): CreateLoadBalancerRequest;
};
        ...
        listenerSpec?: ({
            ...
            http?: ({
                ...
                handler?: ({
                    ...
                    allowHttp10?: boolean | undefined;
                } & Record<Exclude<keyof I["listenerSpec"]["http"]["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                redirects?: ({
                    httpToHttps?: boolean | undefined;
                } & {
                    httpToHttps?: boolean | undefined;
            ...
            tls?: ({
                ...
                defaultHandler?: ({
                    ...
                    httpHandler?: ({
                        ...
                        allowHttp10?: boolean | undefined;
                    } & Record<Exclude<keyof I["listenerSpec"]["tls"]["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                    streamHandler?: ({
                        backendGroupId?: string | undefined;
                    } & {
                        backendGroupId?: string | undefined;
                ...
                sniHandlers?: ({
                    ...
                    handler?: ({
                        ...
                        httpHandler?: ({
                            ...
                            allowHttp10?: boolean | undefined;
                        } & Record<Exclude<keyof I["listenerSpec"]["tls"]["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                        streamHandler?: ({
                            backendGroupId?: string | undefined;
                        } & {
                            backendGroupId?: string | undefined;
    ...
    fromPartial<I extends {
        ...
        http?: ({
            ...
            handler?: ({
                ...
                allowHttp10?: boolean | undefined;
            } & Record<Exclude<keyof I["http"]["handler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
            redirects?: ({
                httpToHttps?: boolean | undefined;
            } & {
                httpToHttps?: boolean | undefined;
        ...
        tls?: ({
            ...
            defaultHandler?: ({
                ...
                httpHandler?: ({
                    ...
                    allowHttp10?: boolean | undefined;
                } & Record<Exclude<keyof I["tls"]["defaultHandler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                streamHandler?: ({
                    backendGroupId?: string | undefined;
                } & {
                    backendGroupId?: string | undefined;
            ...
            sniHandlers?: ({
                ...
                handler?: ({
                    ...
                    httpHandler?: ({
                        ...
                        allowHttp10?: boolean | undefined;
                    } & Record<Exclude<keyof I["tls"]["sniHandlers"][number]["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
                    streamHandler?: ({
                        backendGroupId?: string | undefined;
                    } & {
                        backendGroupId?: string | undefined;
    ...
    fromPartial<I extends {
        ...
        handler?: ({
            ...
            httpHandler?: ({
                ...
                allowHttp10?: boolean | undefined;
            } & Record<Exclude<keyof I["handler"]["httpHandler"], "$type" | "httpRouterId" | "http2Options" | "allowHttp10">, never>) | undefined;
            streamHandler?: ({
                backendGroupId?: string | undefined;
            } & {
                backendGroupId?: string | undefined;
