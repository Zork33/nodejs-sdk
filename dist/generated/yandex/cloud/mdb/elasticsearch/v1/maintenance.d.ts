...
export interface MaintenanceWindow {
    $type: "yandex.cloud.mdb.elasticsearch.v1.MaintenanceWindow";
...
export interface AnytimeMaintenanceWindow {
    $type: "yandex.cloud.mdb.elasticsearch.v1.AnytimeMaintenanceWindow";
}
export interface WeeklyMaintenanceWindow {
    $type: "yandex.cloud.mdb.elasticsearch.v1.WeeklyMaintenanceWindow";
...
export interface MaintenanceOperation {
    $type: "yandex.cloud.mdb.elasticsearch.v1.MaintenanceOperation";
    info: string;
    delayedUntil?: Date;
}
export declare const MaintenanceWindow: {
    ...
    fromPartial<I extends {
        ...
        weeklyMaintenanceWindow?: ({
            ...
            day?: WeeklyMaintenanceWindow_WeekDay | undefined;
            hour?: number | undefined;
        } & Record<Exclude<keyof I["weeklyMaintenanceWindow"], "$type" | "day" | "hour">, never>) | undefined;
...
export declare const WeeklyMaintenanceWindow: {
    ...
    fromPartial<I extends {
        ...
        day?: WeeklyMaintenanceWindow_WeekDay | undefined;
        hour?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "day" | "hour">, never>>(object: I): WeeklyMaintenanceWindow;
};
