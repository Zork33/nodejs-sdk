...
export declare const UpdateAuthProviderRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "name" | "clusterId" | "provider">, never>>(object: I): UpdateAuthProviderRequest;
};
...
export declare const AddAuthProvidersMetadata: {
    ...
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "names">, never>>(object: I): AddAuthProvidersMetadata;
};
export declare const UpdateAuthProvidersMetadata: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        names?: (string[] & string[] & Record<Exclude<keyof I["names"], "$type" | keyof string[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "names">, never>>(object: I): UpdateAuthProvidersMetadata;
};
export declare const DeleteAuthProvidersMetadata: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        names?: (string[] & string[] & Record<Exclude<keyof I["names"], "$type" | keyof string[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "names">, never>>(object: I): DeleteAuthProvidersMetadata;
};
