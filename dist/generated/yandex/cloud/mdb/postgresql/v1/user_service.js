...
exports.UpdateUserRequest = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.settings !== undefined) {
            user_1.UserSettings.encode(message.settings, writer.uint32(58).fork()).ldelim();
        }
        if (message.login !== undefined) {
            wrappers_1.BoolValue.encode({ $type: "google.protobuf.BoolValue", value: message.login }, writer.uint32(66).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        message.settings =
            object.settings !== undefined && object.settings !== null
                ? user_1.UserSettings.fromJSON(object.settings)
                : undefined;
        message.login =
    ...
    fromPartial(object) {
        ...
        message.connLimit = (_e = object.connLimit) !== null && _e !== void 0 ? _e : 0;
        message.settings =
            object.settings !== undefined && object.settings !== null
                ? user_1.UserSettings.fromPartial(object.settings)
                : undefined;
        message.login = (_f = object.login) !== null && _f !== void 0 ? _f : undefined;
        message.grants = ((_g = object.grants) === null || _g === void 0 ? void 0 : _g.map((e) => e)) || [];
        return message;
    },
};
...
exports.RevokeUserPermissionRequest = {
    ...
    fromPartial(object) {
        ...
        message.clusterId = (_a = object.clusterId) !== null && _a !== void 0 ? _a : "";
        message.userName = (_b = object.userName) !== null && _b !== void 0 ? _b : "";
        message.databaseName = (_c = object.databaseName) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
...
exports.UserServiceClient = (0, grpc_js_1.makeGenericClientConstructor)(exports.UserServiceService, "yandex.cloud.mdb.postgresql.v1.UserService");
var globalThis = (() => {
