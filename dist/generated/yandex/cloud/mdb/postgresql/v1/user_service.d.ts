...
import { UserSpec, UserSettings, Permission, User } from "../../../../../yandex/cloud/mdb/postgresql/v1/user";
    ...
    fromPartial<I extends {
        ...
        users?: ({
            ...
            settings?: ({
                ...
                logMinDurationStatement?: number | undefined;
                lockTimeout?: number | undefined;
            } & Record<Exclude<keyof I["users"][number]["settings"], "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "lockTimeout">, never>) | undefined;
            permissions?: ({
                databaseName?: string | undefined;
            }[] & ({
                databaseName?: string | undefined;
            ...
            login?: boolean | undefined;
            connLimit?: number | undefined;
            grants?: (string[] & string[] & Record<Exclude<keyof I["users"][number]["grants"], "$type" | keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["users"][number], "$type" | "name" | "settings" | "permissions" | "clusterId" | "login" | "connLimit" | "grants">, never>)[] & Record<Exclude<keyof I["users"], "$type" | keyof {
            name?: string | undefined;
            settings?: {
                logStatement?: import("../../../../../yandex/cloud/mdb/postgresql/v1/user").UserSettings_LogStatement | undefined;
                synchronousCommit?: import("../../../../../yandex/cloud/mdb/postgresql/v1/user").UserSettings_SynchronousCommit | undefined;
    ...
    fromPartial<I extends {
        ...
        userSpec?: ({
            ...
            settings?: ({
                ...
                logMinDurationStatement?: number | undefined;
                lockTimeout?: number | undefined;
            } & Record<Exclude<keyof I["userSpec"]["settings"], "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "lockTimeout">, never>) | undefined;
            permissions?: ({
                databaseName?: string | undefined;
            }[] & ({
                databaseName?: string | undefined;
            ...
            login?: boolean | undefined;
            connLimit?: number | undefined;
            grants?: (string[] & string[] & Record<Exclude<keyof I["userSpec"]["grants"], "$type" | keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["userSpec"], "$type" | "name" | "settings" | "permissions" | "password" | "login" | "connLimit" | "grants">, never>) | undefined;
...
export declare const UpdateUserRequest: {
    ...
    fromPartial<I extends {
        ...
        settings?: ({
            ...
            logMinDurationStatement?: number | undefined;
            lockTimeout?: number | undefined;
        } & Record<Exclude<keyof I["settings"], "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "lockTimeout">, never>) | undefined;
        permissions?: ({
            databaseName?: string | undefined;
        }[] & ({
            databaseName?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "updateMask" | "settings" | "permissions" | "clusterId" | "password" | "login" | "userName" | "connLimit" | "grants">, never>>(object: I): UpdateUserRequest;
};
