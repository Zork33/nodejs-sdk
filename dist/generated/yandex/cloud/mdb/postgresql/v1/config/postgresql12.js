...
exports.PostgresqlConfigSet12 = exports.PostgresqlConfig12 = exports.postgresqlConfig12_XmlOptionToJSON = exports.postgresqlConfig12_XmlOptionFromJSON = exports.PostgresqlConfig12_XmlOption = exports.postgresqlConfig12_XmlBinaryToJSON = exports.postgresqlConfig12_XmlBinaryFromJSON = exports.PostgresqlConfig12_XmlBinary = exports.postgresqlConfig12_WalLevelToJSON = exports.postgresqlConfig12_WalLevelFromJSON = exports.PostgresqlConfig12_WalLevel = exports.postgresqlConfig12_TransactionIsolationToJSON = exports.postgresqlConfig12_TransactionIsolationFromJSON = exports.PostgresqlConfig12_TransactionIsolation = exports.postgresqlConfig12_SynchronousCommitToJSON = exports.postgresqlConfig12_SynchronousCommitFromJSON = exports.PostgresqlConfig12_SynchronousCommit = exports.postgresqlConfig12_SharedPreloadLibrariesToJSON = exports.postgresqlConfig12_SharedPreloadLibrariesFromJSON = exports.PostgresqlConfig12_SharedPreloadLibraries = exports.postgresqlConfig12_PlanCacheModeToJSON = exports.postgresqlConfig12_PlanCacheModeFromJSON = exports.PostgresqlConfig12_PlanCacheMode = exports.postgresqlConfig12_PgHintPlanDebugPrintToJSON = exports.postgresqlConfig12_PgHintPlanDebugPrintFromJSON = exports.PostgresqlConfig12_PgHintPlanDebugPrint = exports.postgresqlConfig12_LogStatementToJSON = exports.postgresqlConfig12_LogStatementFromJSON = exports.PostgresqlConfig12_LogStatement = exports.postgresqlConfig12_LogLevelToJSON = exports.postgresqlConfig12_LogLevelFromJSON = exports.PostgresqlConfig12_LogLevel = exports.postgresqlConfig12_LogErrorVerbosityToJSON = exports.postgresqlConfig12_LogErrorVerbosityFromJSON = exports.PostgresqlConfig12_LogErrorVerbosity = exports.postgresqlConfig12_ForceParallelModeToJSON = exports.postgresqlConfig12_ForceParallelModeFromJSON = exports.PostgresqlConfig12_ForceParallelMode = exports.postgresqlConfig12_ConstraintExclusionToJSON = exports.postgresqlConfig12_ConstraintExclusionFromJSON = exports.PostgresqlConfig12_ConstraintExclusion = exports.postgresqlConfig12_ByteaOutputToJSON = exports.postgresqlConfig12_ByteaOutputFromJSON = exports.PostgresqlConfig12_ByteaOutput = exports.postgresqlConfig12_BackslashQuoteToJSON = exports.postgresqlConfig12_BackslashQuoteFromJSON = exports.PostgresqlConfig12_BackslashQuote = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (PostgresqlConfig12_SharedPreloadLibraries) {
    ...
    PostgresqlConfig12_SharedPreloadLibraries[PostgresqlConfig12_SharedPreloadLibraries["SHARED_PRELOAD_LIBRARIES_TIMESCALEDB"] = 3] = "SHARED_PRELOAD_LIBRARIES_TIMESCALEDB";
    PostgresqlConfig12_SharedPreloadLibraries[PostgresqlConfig12_SharedPreloadLibraries["SHARED_PRELOAD_LIBRARIES_PG_QUALSTATS"] = 4] = "SHARED_PRELOAD_LIBRARIES_PG_QUALSTATS";
    PostgresqlConfig12_SharedPreloadLibraries[PostgresqlConfig12_SharedPreloadLibraries["SHARED_PRELOAD_LIBRARIES_PG_CRON"] = 5] = "SHARED_PRELOAD_LIBRARIES_PG_CRON";
    PostgresqlConfig12_SharedPreloadLibraries[PostgresqlConfig12_SharedPreloadLibraries["SHARED_PRELOAD_LIBRARIES_PGLOGICAL"] = 6] = "SHARED_PRELOAD_LIBRARIES_PGLOGICAL";
...
exports.PostgresqlConfig12 = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, basePostgresqlConfig12);
    ...
    fromJSON(object) {
        ...
        message.effectiveCacheSize =
            object.effectiveCacheSize !== undefined &&
                ...
                : undefined;
        message.sharedPreloadLibraries = ((_a = object.sharedPreloadLibraries) !== null && _a !== void 0 ? _a : []).map((e) => postgresqlConfig12_SharedPreloadLibrariesFromJSON(e));
    ...
    toJSON(message) {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlConfig12_ConstraintExclusionToJSON(message.constraintExclusion));
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlConfig12_PgHintPlanDebugPrintToJSON(message.pgHintPlanDebugPrint));
    ...
    fromPartial(object) {
        ...
        message.pgQualstatsEnabled = (_97 = object.pgQualstatsEnabled) !== null && _97 !== void 0 ? _97 : undefined;
        message.pgQualstatsTrackConstants =
            (_98 = object.pgQualstatsTrackConstants) !== null && _98 !== void 0 ? _98 : undefined;
        message.pgQualstatsMax = (_99 = object.pgQualstatsMax) !== null && _99 !== void 0 ? _99 : undefined;
        message.pgQualstatsResolveOids = (_100 = object.pgQualstatsResolveOids) !== null && _100 !== void 0 ? _100 : undefined;
        message.pgQualstatsSampleRate = (_101 = object.pgQualstatsSampleRate) !== null && _101 !== void 0 ? _101 : undefined;
...
exports.PostgresqlConfigSet12 = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, basePostgresqlConfigSet12);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.PostgresqlConfig12.fromJSON(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.PostgresqlConfig12.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.PostgresqlConfig12.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.PostgresqlConfig12.fromPartial(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.PostgresqlConfig12.fromPartial(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.PostgresqlConfig12.fromPartial(object.defaultConfig)
                : undefined;
        return message;
    },
};
