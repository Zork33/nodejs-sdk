...
export declare const User: {
    ...
    } & Record<Exclude<keyof I, "$type" | "name" | "settings" | "permissions" | "clusterId" | "login" | "connLimit" | "grants">, never>>(object: I): User;
};
...
export declare const UserSpec: {
    ...
    fromPartial<I extends {
        ...
        connLimit?: number | undefined;
        grants?: (string[] & string[] & Record<Exclude<keyof I["grants"], "$type" | keyof string[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "name" | "settings" | "permissions" | "password" | "login" | "connLimit" | "grants">, never>>(object: I): UserSpec;
};
export declare const UserSettings: {
    ...
    fromPartial<I extends {
        ...
        logMinDurationStatement?: number | undefined;
        lockTimeout?: number | undefined;
    } & Record<Exclude<keyof I, "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "lockTimeout">, never>>(object: I): UserSettings;
};
