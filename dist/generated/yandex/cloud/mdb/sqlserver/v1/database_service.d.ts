...
export declare const RestoreDatabaseRequest: {
    ...
    fromPartial<I extends {
        ...
        time?: Date | undefined;
        fromDatabase?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "databaseName" | "backupId" | "time" | "fromDatabase">, never>>(object: I): RestoreDatabaseRequest;
};
export declare const RestoreDatabaseMetadata: {
    ...
    fromPartial<I extends {
        ...
        backupId?: string | undefined;
        fromDatabase?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "databaseName" | "backupId" | "fromDatabase">, never>>(object: I): RestoreDatabaseMetadata;
};
export declare const ImportDatabaseBackupRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "databaseName" | "s3Bucket" | "s3Path" | "files">, never>>(object: I): ImportDatabaseBackupRequest;
};
...
export declare const ExportDatabaseBackupRequest: {
    ...
    fromPartial<I extends {
        ...
        s3Path?: string | undefined;
        prefix?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "databaseName" | "s3Bucket" | "s3Path" | "prefix">, never>>(object: I): ExportDatabaseBackupRequest;
};
