...
export interface MaintenanceWindow {
    $type: "yandex.cloud.mdb.mongodb.v1.MaintenanceWindow";
...
export interface AnytimeMaintenanceWindow {
    $type: "yandex.cloud.mdb.mongodb.v1.AnytimeMaintenanceWindow";
}
/** Weelky maintenance window settings. */
export interface WeeklyMaintenanceWindow {
    $type: "yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindow";
...
export interface MaintenanceOperation {
    $type: "yandex.cloud.mdb.mongodb.v1.MaintenanceOperation";
