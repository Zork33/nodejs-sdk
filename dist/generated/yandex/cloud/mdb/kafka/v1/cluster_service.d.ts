...
export declare const ListClustersResponse: {
    ...
    fromPartial<I extends {
            ...
            config?: ({
                ...
                kafka?: ({
                    ...
                    kafkaConfig26?: ({
                        ...
                        messageMaxBytes?: number | undefined;
                        replicaFetchMaxBytes?: number | undefined;
                        sslCipherSuites?: (string[] & string[] & Record<Exclude<keyof I["clusters"][number]["config"]["kafka"]["kafkaConfig26"]["sslCipherSuites"], "$type" | keyof string[]>, never>) | undefined;
                        offsetsRetentionMinutes?: number | undefined;
                    } & Record<Exclude<keyof I["clusters"][number]["config"]["kafka"]["kafkaConfig26"], "$type" | "compressionType" | "logFlushIntervalMessages" | "logFlushIntervalMs" | "logFlushSchedulerIntervalMs" | "logRetentionBytes" | "logRetentionHours" | "logRetentionMinutes" | "logRetentionMs" | "logSegmentBytes" | "logPreallocate" | "socketSendBufferBytes" | "socketReceiveBufferBytes" | "autoCreateTopicsEnable" | "numPartitions" | "defaultReplicationFactor" | "messageMaxBytes" | "replicaFetchMaxBytes" | "sslCipherSuites" | "offsetsRetentionMinutes">, never>) | undefined;
                    kafkaConfig28?: ({
                        compressionType?: import("./common").CompressionType | undefined;
                        logFlushIntervalMessages?: number | undefined;
                        logFlushIntervalMs?: number | undefined;
                ...
                } & Record<Exclude<keyof I["clusters"][number]["config"]["kafka"], "$type" | "resources" | "kafkaConfig21" | "kafkaConfig26" | "kafkaConfig28" | "kafkaConfig3">, never>) | undefined;
                access?: ({
                    dataTransfer?: boolean | undefined;
                } & {
                    dataTransfer?: boolean | undefined;
                ...
                unmanagedTopics?: boolean | undefined;
                schemaRegistry?: boolean | undefined;
            } & Record<Exclude<keyof I["clusters"][number]["config"], "$type" | "zoneId" | "version" | "assignPublicIp" | "zookeeper" | "kafka" | "access" | "brokersCount" | "unmanagedTopics" | "schemaRegistry">, never>) | undefined;
            folderId?: string | undefined;
            status?: import("../../../../../yandex/cloud/mdb/kafka/v1/cluster").Cluster_Status | undefined;
            name?: string | undefined;
            labels?: ({
        ...
        } & Record<Exclude<keyof I["clusters"][number], "$type" | "description" | "id" | "createdAt" | "config" | "folderId" | "status" | "name" | "labels" | "networkId" | "securityGroupIds" | "deletionProtection" | "health" | "hostGroupIds" | "monitoring" | "maintenanceWindow" | "environment" | "plannedOperation">, never>)[] & Record<Exclude<keyof I["clusters"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            config?: {
...
export declare const CreateClusterRequest: {
    ...
    fromPartial<I extends {
        ...
        configSpec?: ({
            ...
            kafka?: ({
                ...
                kafkaConfig21?: ({
                    ...
                    messageMaxBytes?: number | undefined;
                    replicaFetchMaxBytes?: number | undefined;
                    sslCipherSuites?: (string[] & string[] & Record<Exclude<keyof I["configSpec"]["kafka"]["kafkaConfig21"]["sslCipherSuites"], "$type" | keyof string[]>, never>) | undefined;
                    offsetsRetentionMinutes?: number | undefined;
                } & Record<Exclude<keyof I["configSpec"]["kafka"]["kafkaConfig21"], "$type" | "compressionType" | "logFlushIntervalMessages" | "logFlushIntervalMs" | "logFlushSchedulerIntervalMs" | "logRetentionBytes" | "logRetentionHours" | "logRetentionMinutes" | "logRetentionMs" | "logSegmentBytes" | "logPreallocate" | "socketSendBufferBytes" | "socketReceiveBufferBytes" | "autoCreateTopicsEnable" | "numPartitions" | "defaultReplicationFactor" | "messageMaxBytes" | "replicaFetchMaxBytes" | "sslCipherSuites" | "offsetsRetentionMinutes">, never>) | undefined;
                kafkaConfig26?: ({
                    compressionType?: import("./common").CompressionType | undefined;
                    logFlushIntervalMessages?: number | undefined;
                    logFlushIntervalMs?: number | undefined;
                    ...
                    messageMaxBytes?: number | undefined;
                    replicaFetchMaxBytes?: number | undefined;
                    sslCipherSuites?: (string[] & string[] & Record<Exclude<keyof I["configSpec"]["kafka"]["kafkaConfig26"]["sslCipherSuites"], "$type" | keyof string[]>, never>) | undefined;
                    offsetsRetentionMinutes?: number | undefined;
                } & Record<Exclude<keyof I["configSpec"]["kafka"]["kafkaConfig26"], "$type" | "compressionType" | "logFlushIntervalMessages" | "logFlushIntervalMs" | "logFlushSchedulerIntervalMs" | "logRetentionBytes" | "logRetentionHours" | "logRetentionMinutes" | "logRetentionMs" | "logSegmentBytes" | "logPreallocate" | "socketSendBufferBytes" | "socketReceiveBufferBytes" | "autoCreateTopicsEnable" | "numPartitions" | "defaultReplicationFactor" | "messageMaxBytes" | "replicaFetchMaxBytes" | "sslCipherSuites" | "offsetsRetentionMinutes">, never>) | undefined;
                kafkaConfig28?: ({
                    compressionType?: import("./common").CompressionType | undefined;
                    logFlushIntervalMessages?: number | undefined;
                    logFlushIntervalMs?: number | undefined;
            ...
            } & Record<Exclude<keyof I["configSpec"]["kafka"], "$type" | "resources" | "kafkaConfig21" | "kafkaConfig26" | "kafkaConfig28" | "kafkaConfig3">, never>) | undefined;
            access?: ({
                dataTransfer?: boolean | undefined;
            } & {
                dataTransfer?: boolean | undefined;
            ...
            unmanagedTopics?: boolean | undefined;
            schemaRegistry?: boolean | undefined;
        } & Record<Exclude<keyof I["configSpec"], "$type" | "zoneId" | "version" | "assignPublicIp" | "zookeeper" | "kafka" | "access" | "brokersCount" | "unmanagedTopics" | "schemaRegistry">, never>) | undefined;
        maintenanceWindow?: ({
            anytime?: {} | undefined;
            weeklyMaintenanceWindow?: {
                day?: import("../../../../../yandex/cloud/mdb/kafka/v1/maintenance").WeeklyMaintenanceWindow_WeekDay | undefined;
        ...
        userSpecs?: ({
            ...
            permissions?: ({
                ...
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            } & Record<Exclude<keyof I["userSpecs"][number]["permissions"][number], "$type" | "role" | "topicName">, never>)[] & Record<Exclude<keyof I["userSpecs"][number]["permissions"], "$type" | keyof {
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            }[]>, never>) | undefined;
            password?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "subnetId" | "networkId" | "securityGroupIds" | "deletionProtection" | "hostGroupIds" | "configSpec" | "maintenanceWindow" | "environment" | "userSpecs" | "topicSpecs">, never>>(object: I): CreateClusterRequest;
};
