...
exports.ConfigSpec_Kafka = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.kafkaConfig21 !== undefined) {
            exports.Kafkaconfig21.encode(message.kafkaConfig21, writer.uint32(18).fork()).ldelim();
        }
        if (message.kafkaConfig26 !== undefined) {
            exports.Kafkaconfig26.encode(message.kafkaConfig26, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.kafkaConfig21 = exports.Kafkaconfig21.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.kafkaConfig26 = exports.Kafkaconfig26.decode(reader, reader.uint32());
                    break;
                case 4:
    ...
    fromJSON(object) {
        ...
        message.kafkaConfig21 =
            object.kafkaConfig_2_1 !== undefined && object.kafkaConfig_2_1 !== null
                ? exports.Kafkaconfig21.fromJSON(object.kafkaConfig_2_1)
                : undefined;
        message.kafkaConfig26 =
            object.kafkaConfig_2_6 !== undefined && object.kafkaConfig_2_6 !== null
                ? exports.Kafkaconfig26.fromJSON(object.kafkaConfig_2_6)
                : undefined;
    ...
    toJSON(message) {
        ...
        message.kafkaConfig21 !== undefined &&
            (obj.kafkaConfig_2_1 = message.kafkaConfig21
                ? exports.Kafkaconfig21.toJSON(message.kafkaConfig21)
                : undefined);
        message.kafkaConfig26 !== undefined &&
            (obj.kafkaConfig_2_6 = message.kafkaConfig26
                ? exports.Kafkaconfig26.toJSON(message.kafkaConfig26)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.kafkaConfig21 =
            object.kafkaConfig21 !== undefined && object.kafkaConfig21 !== null
                ? exports.Kafkaconfig21.fromPartial(object.kafkaConfig21)
                : undefined;
        message.kafkaConfig26 =
            object.kafkaConfig26 !== undefined && object.kafkaConfig26 !== null
                ? exports.Kafkaconfig26.fromPartial(object.kafkaConfig26)
                : undefined;
        message.kafkaConfig28 =
...
exports.Kafkaconfig21 = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseKafkaconfig21);
...
typeRegistry_1.messageTypeRegistry.set(exports.Kafkaconfig21.$type, exports.Kafkaconfig21);
const baseKafkaconfig26 = {
    $type: "yandex.cloud.mdb.kafka.v1.KafkaConfig2_6",
    compressionType: 0,
    sslCipherSuites: "",
};
exports.Kafkaconfig26 = {
    $type: "yandex.cloud.mdb.kafka.v1.KafkaConfig2_6",
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.compressionType !== 0) {
            writer.uint32(8).int32(message.compressionType);
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseKafkaconfig26);
        message.sslCipherSuites = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
typeRegistry_1.messageTypeRegistry.set(exports.Kafkaconfig26.$type, exports.Kafkaconfig26);
