...
export declare const ListConnectorsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["connectors"][number], "$type" | "status" | "name" | "properties" | "health" | "clusterId" | "tasksMax" | "connectorConfigMirrormaker" | "connectorConfigS3Sink">, never>)[] & Record<Exclude<keyof I["connectors"], "$type" | keyof {
            status?: import("../../../../../yandex/cloud/mdb/kafka/v1/connector").Connector_Status | undefined;
            name?: string | undefined;
            properties?: {
                [x: string]: string | undefined;
