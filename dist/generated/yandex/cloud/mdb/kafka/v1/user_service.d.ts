    ...
    fromPartial<I extends {
        ...
        users?: ({
            ...
            permissions?: ({
                ...
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            } & Record<Exclude<keyof I["users"][number]["permissions"][number], "$type" | "role" | "topicName">, never>)[] & Record<Exclude<keyof I["users"][number]["permissions"], "$type" | keyof {
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            }[]>, never>) | undefined;
            clusterId?: string | undefined;
    ...
    fromPartial<I extends {
        ...
        userSpec?: ({
            ...
            permissions?: ({
                ...
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            } & Record<Exclude<keyof I["userSpec"]["permissions"][number], "$type" | "role" | "topicName">, never>)[] & Record<Exclude<keyof I["userSpec"]["permissions"], "$type" | keyof {
                role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
                topicName?: string | undefined;
            }[]>, never>) | undefined;
            password?: string | undefined;
...
export declare const UpdateUserRequest: {
    ...
    fromPartial<I extends {
        ...
        permissions?: ({
            ...
            role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
            topicName?: string | undefined;
        } & Record<Exclude<keyof I["permissions"][number], "$type" | "role" | "topicName">, never>)[] & Record<Exclude<keyof I["permissions"], "$type" | keyof {
            role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
            topicName?: string | undefined;
        }[]>, never>) | undefined;
        clusterId?: string | undefined;
...
export declare const GrantUserPermissionRequest: {
    ...
    fromPartial<I extends {
        ...
        permission?: ({
            ...
            role?: import("../../../../../yandex/cloud/mdb/kafka/v1/user").Permission_AccessRole | undefined;
            topicName?: string | undefined;
        } & Record<Exclude<keyof I["permission"], "$type" | "role" | "topicName">, never>) | undefined;
