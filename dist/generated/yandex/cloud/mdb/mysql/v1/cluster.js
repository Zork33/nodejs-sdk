...
exports.ClusterConfig = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.mysqlConfig80 !== undefined) {
            mysql8_0_1.Mysqlconfigset80.encode(message.mysqlConfig80, writer.uint32(50).fork()).ldelim();
        }
        ...
        if (message.performanceDiagnostics !== undefined) {
            exports.PerformanceDiagnostics.encode(message.performanceDiagnostics, writer.uint32(58).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 6:
                    message.mysqlConfig80 = mysql8_0_1.Mysqlconfigset80.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        message.mysqlConfig80 =
            object.mysqlConfig_8_0 !== undefined && object.mysqlConfig_8_0 !== null
                ? mysql8_0_1.Mysqlconfigset80.fromJSON(object.mysqlConfig_8_0)
                : undefined;
        message.resources =
    ...
    toJSON(message) {
        ...
        message.mysqlConfig80 !== undefined &&
            (obj.mysqlConfig_8_0 = message.mysqlConfig80
                ? mysql8_0_1.Mysqlconfigset80.toJSON(message.mysqlConfig80)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.mysqlConfig80 =
            object.mysqlConfig80 !== undefined && object.mysqlConfig80 !== null
                ? mysql8_0_1.Mysqlconfigset80.fromPartial(object.mysqlConfig80)
                : undefined;
        message.resources =
            object.resources !== undefined && object.resources !== null
...
exports.Host = {
    ...
    fromPartial(object) {
        ...
        message.replicationSource = (_j = object.replicationSource) !== null && _j !== void 0 ? _j : "";
        message.backupPriority = (_k = object.backupPriority) !== null && _k !== void 0 ? _k : 0;
        message.priority = (_l = object.priority) !== null && _l !== void 0 ? _l : 0;
        return message;
    },
};
