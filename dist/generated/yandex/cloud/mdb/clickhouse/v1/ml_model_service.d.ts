...
export declare const GetMlModelRequest: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "mlModelName">, never>>(object: I): GetMlModelRequest;
};
export declare const ListMlModelsRequest: {
    ...
    fromPartial<I extends {
        ...
        pageToken?: string | undefined;
        clusterId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "clusterId">, never>>(object: I): ListMlModelsRequest;
};
export declare const ListMlModelsResponse: {
    ...
    fromPartial<I extends {
        ...
        mlModels?: ({
            ...
            name?: string | undefined;
            clusterId?: string | undefined;
        } & Record<Exclude<keyof I["mlModels"][number], "$type" | "type" | "uri" | "name" | "clusterId">, never>)[] & Record<Exclude<keyof I["mlModels"], "$type" | keyof {
            type?: MlModelType | undefined;
            uri?: string | undefined;
            name?: string | undefined;
            clusterId?: string | undefined;
        }[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "mlModels">, never>>(object: I): ListMlModelsResponse;
};
export declare const CreateMlModelRequest: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "type" | "uri" | "clusterId" | "mlModelName">, never>>(object: I): CreateMlModelRequest;
};
export declare const CreateMlModelMetadata: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "mlModelName">, never>>(object: I): CreateMlModelMetadata;
};
export declare const UpdateMlModelRequest: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "uri" | "updateMask" | "clusterId" | "mlModelName">, never>>(object: I): UpdateMlModelRequest;
};
export declare const UpdateMlModelMetadata: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "mlModelName">, never>>(object: I): UpdateMlModelMetadata;
};
export declare const DeleteMlModelRequest: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "mlModelName">, never>>(object: I): DeleteMlModelRequest;
};
export declare const DeleteMlModelMetadata: {
    ...
    fromPartial<I extends {
        ...
        clusterId?: string | undefined;
        mlModelName?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "clusterId" | "mlModelName">, never>>(object: I): DeleteMlModelMetadata;
};
...
export declare const MlModelServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): MlModelServiceClient;
