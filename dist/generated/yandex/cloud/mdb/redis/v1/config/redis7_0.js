...
exports.Redisconfigset70 = exports.Redisconfig70_ClientOutputBufferLimit = exports.Redisconfig70 = exports.redisconfig70_MaxmemoryPolicyToJSON = exports.redisconfig70_MaxmemoryPolicyFromJSON = exports.Redisconfig70_MaxmemoryPolicy = exports.protobufPackage = void 0;
/* eslint-disable */
...
var Redisconfig70_MaxmemoryPolicy;
(function (Redisconfig70_MaxmemoryPolicy) {
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["MAXMEMORY_POLICY_UNSPECIFIED"] = 0] = "MAXMEMORY_POLICY_UNSPECIFIED";
    /** VOLATILE_LRU - Try to remove less recently used (LRU) keys with `expire set`. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["VOLATILE_LRU"] = 1] = "VOLATILE_LRU";
    /** ALLKEYS_LRU - Remove less recently used (LRU) keys. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["ALLKEYS_LRU"] = 2] = "ALLKEYS_LRU";
    /** VOLATILE_LFU - Try to remove least frequently used (LFU) keys with `expire set`. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["VOLATILE_LFU"] = 3] = "VOLATILE_LFU";
    /** ALLKEYS_LFU - Remove least frequently used (LFU) keys. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["ALLKEYS_LFU"] = 4] = "ALLKEYS_LFU";
    /** VOLATILE_RANDOM - Try to remove keys with `expire set` randomly. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["VOLATILE_RANDOM"] = 5] = "VOLATILE_RANDOM";
    /** ALLKEYS_RANDOM - Remove keys randomly. */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["ALLKEYS_RANDOM"] = 6] = "ALLKEYS_RANDOM";
    /**
     * VOLATILE_TTL - Try to remove less recently used (LRU) keys with `expire set`
     * and shorter TTL first.
     */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["VOLATILE_TTL"] = 7] = "VOLATILE_TTL";
    /**
     * NOEVICTION - Return errors when memory limit was reached and commands could require
     * more memory to be used.
     */
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["NOEVICTION"] = 8] = "NOEVICTION";
    Redisconfig70_MaxmemoryPolicy[Redisconfig70_MaxmemoryPolicy["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Redisconfig70_MaxmemoryPolicy = exports.Redisconfig70_MaxmemoryPolicy || (exports.Redisconfig70_MaxmemoryPolicy = {}));
function redisconfig70_MaxmemoryPolicyFromJSON(object) {
    switch (object) {
        case 0:
...
exports.redisconfig70_MaxmemoryPolicyFromJSON = redisconfig70_MaxmemoryPolicyFromJSON;
function redisconfig70_MaxmemoryPolicyToJSON(object) {
    switch (object) {
...
exports.redisconfig70_MaxmemoryPolicyToJSON = redisconfig70_MaxmemoryPolicyToJSON;
const baseRedisconfig70 = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig7_0",
    maxmemoryPolicy: 0,
    password: "",
    notifyKeyspaceEvents: "",
};
exports.Redisconfig70 = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig7_0",
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.clientOutputBufferLimitPubsub !== undefined) {
            exports.Redisconfig70_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitPubsub, writer.uint32(66).fork()).ldelim();
        }
        if (message.clientOutputBufferLimitNormal !== undefined) {
            exports.Redisconfig70_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitNormal, writer.uint32(74).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        const message = Object.assign({}, baseRedisconfig70);
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    message.clientOutputBufferLimitPubsub =
                        exports.Redisconfig70_ClientOutputBufferLimit.decode(reader, reader.uint32());
                    break;
                case 9:
    ...
    fromJSON(object) {
        ...
        message.clientOutputBufferLimitPubsub =
            object.clientOutputBufferLimitPubsub !== undefined &&
                ...
                ? exports.Redisconfig70_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitPubsub)
                : undefined;
        message.clientOutputBufferLimitNormal =
            object.clientOutputBufferLimitNormal !== undefined &&
                object.clientOutputBufferLimitNormal !== null
                ? exports.Redisconfig70_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitNormal)
                : undefined;
        return message;
    },
    toJSON(message) {
        ...
        message.clientOutputBufferLimitPubsub !== undefined &&
            (obj.clientOutputBufferLimitPubsub = message.clientOutputBufferLimitPubsub
                ? exports.Redisconfig70_ClientOutputBufferLimit.toJSON(message.clientOutputBufferLimitPubsub)
                : undefined);
        message.clientOutputBufferLimitNormal !== undefined &&
            (obj.clientOutputBufferLimitNormal = message.clientOutputBufferLimitNormal
                ? exports.Redisconfig70_ClientOutputBufferLimit.toJSON(message.clientOutputBufferLimitNormal)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.clientOutputBufferLimitPubsub =
            object.clientOutputBufferLimitPubsub !== undefined &&
                object.clientOutputBufferLimitPubsub !== null
                ? exports.Redisconfig70_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitPubsub)
                : undefined;
        message.clientOutputBufferLimitNormal =
            object.clientOutputBufferLimitNormal !== undefined &&
                object.clientOutputBufferLimitNormal !== null
                ? exports.Redisconfig70_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitNormal)
                : undefined;
        return message;
    },
};
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfig70.$type, exports.Redisconfig70);
const baseRedisconfig70_ClientOutputBufferLimit = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.ClientOutputBufferLimit",
};
exports.Redisconfig70_ClientOutputBufferLimit = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.ClientOutputBufferLimit",
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRedisconfig70_ClientOutputBufferLimit);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfig70_ClientOutputBufferLimit.$type, exports.Redisconfig70_ClientOutputBufferLimit);
const baseRedisconfigset70 = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfigSet7_0",
};
exports.Redisconfigset70 = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfigSet7_0",
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.effectiveConfig !== undefined) {
            exports.Redisconfig70.encode(message.effectiveConfig, writer.uint32(10).fork()).ldelim();
        }
        if (message.userConfig !== undefined) {
            exports.Redisconfig70.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
        }
        if (message.defaultConfig !== undefined) {
            exports.Redisconfig70.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRedisconfigset70);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = exports.Redisconfig70.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.userConfig = exports.Redisconfig70.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.defaultConfig = exports.Redisconfig70.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.Redisconfig70.fromJSON(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.Redisconfig70.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.Redisconfig70.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    toJSON(message) {
        ...
        message.effectiveConfig !== undefined &&
            (obj.effectiveConfig = message.effectiveConfig
                ? exports.Redisconfig70.toJSON(message.effectiveConfig)
                : undefined);
        message.userConfig !== undefined &&
            (obj.userConfig = message.userConfig
                ? exports.Redisconfig70.toJSON(message.userConfig)
                : undefined);
        message.defaultConfig !== undefined &&
            (obj.defaultConfig = message.defaultConfig
                ? exports.Redisconfig70.toJSON(message.defaultConfig)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.Redisconfig70.fromPartial(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.Redisconfig70.fromPartial(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.Redisconfig70.fromPartial(object.defaultConfig)
                : undefined;
        return message;
    },
};
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfigset70.$type, exports.Redisconfigset70);
