...
exports.CreateClusterRequest = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.tlsEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ $type: "google.protobuf.BoolValue", value: message.tlsEnabled }, writer.uint32(106).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        message.persistenceMode =
            object.persistenceMode !== undefined && object.persistenceMode !== null
                ? (0, cluster_1.cluster_PersistenceModeFromJSON)(object.persistenceMode)
                : 0;
        return message;
    },
    toJSON(message) {
        ...
        message.persistenceMode !== undefined &&
            (obj.persistenceMode = (0, cluster_1.cluster_PersistenceModeToJSON)(message.persistenceMode));
        return obj;
    },
    fromPartial(object) {
        ...
        message.sharded = (_h = object.sharded) !== null && _h !== void 0 ? _h : false;
        message.securityGroupIds = ((_j = object.securityGroupIds) === null || _j === void 0 ? void 0 : _j.map((e) => e)) || [];
        message.tlsEnabled = (_k = object.tlsEnabled) !== null && _k !== void 0 ? _k : undefined;
        message.deletionProtection = (_l = object.deletionProtection) !== null && _l !== void 0 ? _l : false;
        message.persistenceMode = (_m = object.persistenceMode) !== null && _m !== void 0 ? _m : 0;
        return message;
    },
};
...
exports.UpdateClusterRequest = {
    ...
    fromPartial(object) {
        ...
        message.persistenceMode = (_g = object.persistenceMode) !== null && _g !== void 0 ? _g : 0;
        return message;
    },
};
...
exports.RestoreClusterRequest = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.tlsEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ $type: "google.protobuf.BoolValue", value: message.tlsEnabled }, writer.uint32(90).fork()).ldelim();
        }
        if (message.persistenceMode !== 0) {
    ...
    fromPartial(object) {
        ...
        message.securityGroupIds = ((_j = object.securityGroupIds) === null || _j === void 0 ? void 0 : _j.map((e) => e)) || [];
        message.tlsEnabled = (_k = object.tlsEnabled) !== null && _k !== void 0 ? _k : undefined;
        message.persistenceMode = (_l = object.persistenceMode) !== null && _l !== void 0 ? _l : 0;
...
const baseLogRecord = { $type: "yandex.cloud.mdb.redis.v1.LogRecord" };
exports.LogRecord = {
...
exports.RebalanceClusterRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRebalanceClusterRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.RebalanceClusterRequest.$type, exports.RebalanceClusterRequest);
const baseRebalanceClusterMetadata = {
...
exports.RebalanceClusterMetadata = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRebalanceClusterMetadata);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.RebalanceClusterMetadata.$type, exports.RebalanceClusterMetadata);
...
exports.UpdateHostSpec = {
    ...
    fromPartial(object) {
        ...
        message.replicaPriority = (_b = object.replicaPriority) !== null && _b !== void 0 ? _b : undefined;
...
exports.HostSpec = {
    ...
    fromPartial(object) {
        ...
        message.shardName = (_c = object.shardName) !== null && _c !== void 0 ? _c : "";
        message.replicaPriority = (_d = object.replicaPriority) !== null && _d !== void 0 ? _d : undefined;
...
exports.ConfigSpec = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.redisConfig70 !== undefined) {
            redis7_0_1.Redisconfig70.encode(message.redisConfig70, writer.uint32(66).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    message.redisConfig70 = redis7_0_1.Redisconfig70.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    toJSON(message) {
        ...
        message.redisConfig70 !== undefined &&
            (obj.redisConfig_7_0 = message.redisConfig70
                ? redis7_0_1.Redisconfig70.toJSON(message.redisConfig70)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.redisConfig50 =
            object.redisConfig50 !== undefined && object.redisConfig50 !== null
                ? redis5_0_1.Redisconfig50.fromPartial(object.redisConfig50)
                : undefined;
        message.redisConfig60 =
            object.redisConfig60 !== undefined && object.redisConfig60 !== null
                ? redis6_0_1.Redisconfig60.fromPartial(object.redisConfig60)
                : undefined;
        message.redisConfig62 =
            object.redisConfig62 !== undefined && object.redisConfig62 !== null
                ? redis6_2_1.Redisconfig62.fromPartial(object.redisConfig62)
                : undefined;
        message.redisConfig70 =
            object.redisConfig70 !== undefined && object.redisConfig70 !== null
                ? redis7_0_1.Redisconfig70.fromPartial(object.redisConfig70)
                : undefined;
        message.resources =
            object.resources !== undefined && object.resources !== null
