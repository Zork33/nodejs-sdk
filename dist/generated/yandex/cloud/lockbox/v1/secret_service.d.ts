...
export declare const ListSecretsResponse: {
    ...
    fromPartial<I extends {
        ...
        secrets?: ({
            ...
            kmsKeyId?: string | undefined;
        } & Record<Exclude<keyof I["secrets"][number], "$type" | "description" | "id" | "createdAt" | "folderId" | "status" | "name" | "labels" | "deletionProtection" | "currentVersion" | "kmsKeyId">, never>)[] & Record<Exclude<keyof I["secrets"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            folderId?: string | undefined;
...
export declare const CreateSecretRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "deletionProtection" | "kmsKeyId" | "versionDescription" | "versionPayloadEntries">, never>>(object: I): CreateSecretRequest;
};
