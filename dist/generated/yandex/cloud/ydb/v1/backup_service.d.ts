...
export declare const ListBackupsResponse: {
    ...
    fromPartial<I extends {
        ...
        backups?: ({
            ...
            databaseId?: string | undefined;
            completedAt?: Date | undefined;
        } & Record<Exclude<keyof I["backups"][number], "$type" | "description" | "id" | "type" | "createdAt" | "folderId" | "status" | "name" | "size" | "startedAt" | "backupSettings" | "databaseId" | "completedAt">, never>)[] & Record<Exclude<keyof I["backups"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            type?: import("../../../../yandex/cloud/ydb/v1/backup").Backup_Type | undefined;
            createdAt?: Date | undefined;
