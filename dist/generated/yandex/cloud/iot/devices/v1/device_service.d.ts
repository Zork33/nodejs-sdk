...
export declare const ListDevicesResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["devices"][number], "$type" | "description" | "id" | "createdAt" | "status" | "name" | "registryId" | "topicAliases" | "monitoringData">, never>)[] & Record<Exclude<keyof I["devices"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            createdAt?: Date | undefined;
            status?: import("../../../../../yandex/cloud/iot/devices/v1/device").Device_Status | undefined;
