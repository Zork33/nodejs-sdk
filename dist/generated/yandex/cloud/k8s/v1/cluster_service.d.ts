...
import { NetworkPolicy, IPAllocationPolicy, MasterMaintenancePolicy, ReleaseChannel, KMSProvider, Cluster, Cilium } from "../../../../yandex/cloud/k8s/v1/cluster";
...
export declare const ListClustersResponse: {
    ...
    fromPartial<I extends {
        ...
        clusters?: ({
            ...
            } & Record<Exclude<keyof I["clusters"][number]["master"], "$type" | "securityGroupIds" | "endpoints" | "maintenancePolicy" | "version" | "zonalMaster" | "regionalMaster" | "masterAuth" | "versionInfo">, never>) | undefined;
            ipAllocationPolicy?: ({
                clusterIpv4CidrBlock?: string | undefined;
                nodeIpv4CidrMaskSize?: number | undefined;
                serviceIpv4CidrBlock?: string | undefined;
...
export declare const UpdateClusterRequest: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["masterSpec"], "$type" | "securityGroupIds" | "maintenancePolicy" | "version">, never>) | undefined;
...
export declare const MasterUpdateSpec: {
    ...
    } & Record<Exclude<keyof I, "$type" | "securityGroupIds" | "maintenancePolicy" | "version">, never>>(object: I): MasterUpdateSpec;
};
...
export declare const CreateClusterRequest: {
    ...
    fromPartial<I extends {
        ...
        masterSpec?: ({
            ...
            } & Record<Exclude<keyof I["masterSpec"]["zonalMasterSpec"], "$type" | "zoneId" | "internalV4AddressSpec" | "externalV4AddressSpec">, never>) | undefined;
            regionalMasterSpec?: ({
                regionId?: string | undefined;
                locations?: {
                    zoneId?: string | undefined;
        ...
        } & Record<Exclude<keyof I["masterSpec"], "$type" | "securityGroupIds" | "maintenancePolicy" | "version" | "zonalMasterSpec" | "regionalMasterSpec">, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "description" | "folderId" | "name" | "labels" | "networkId" | "serviceAccountId" | "nodeServiceAccountId" | "releaseChannel" | "ipAllocationPolicy" | "gatewayIpv4Address" | "networkPolicy" | "kmsProvider" | "cilium" | "masterSpec">, never>>(object: I): CreateClusterRequest;
};
...
export declare const ListClusterNodeGroupsResponse: {
    ...
    fromPartial<I extends {
        ...
        nodeGroups?: ({
            ...
            } & Record<Exclude<keyof I["nodeGroups"][number]["nodeTemplate"], "$type" | "metadata" | "name" | "labels" | "platformId" | "schedulingPolicy" | "networkSettings" | "placementPolicy" | "resourcesSpec" | "bootDiskSpec" | "networkInterfaceSpecs" | "v4AddressSpec" | "containerRuntimeSettings">, never>) | undefined;
            nodeTaints?: ({
                value?: string | undefined;
                key?: string | undefined;
                effect?: import("../../../../yandex/cloud/k8s/v1/node").Taint_Effect | undefined;
...
export declare const MasterSpec: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["zonalMasterSpec"], "$type" | "zoneId" | "internalV4AddressSpec" | "externalV4AddressSpec">, never>) | undefined;
        regionalMasterSpec?: ({
            regionId?: string | undefined;
            locations?: {
                zoneId?: string | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "securityGroupIds" | "maintenancePolicy" | "version" | "zonalMasterSpec" | "regionalMasterSpec">, never>>(object: I): MasterSpec;
};
export declare const ZonalMasterSpec: {
    ...
    } & Record<Exclude<keyof I, "$type" | "zoneId" | "internalV4AddressSpec" | "externalV4AddressSpec">, never>>(object: I): ZonalMasterSpec;
};
