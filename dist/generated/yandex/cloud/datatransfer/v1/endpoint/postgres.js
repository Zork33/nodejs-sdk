...
exports.PostgresObjectTransferSettings = {
    ...
    fromPartial(object) {
        ...
        message.table = (_c = object.table) !== null && _c !== void 0 ? _c : 0;
        message.primaryKey = (_d = object.primaryKey) !== null && _d !== void 0 ? _d : 0;
        message.fkConstraint = (_e = object.fkConstraint) !== null && _e !== void 0 ? _e : 0;
        message.defaultValues = (_f = object.defaultValues) !== null && _f !== void 0 ? _f : 0;
        message.constraint = (_g = object.constraint) !== null && _g !== void 0 ? _g : 0;
        message.index = (_h = object.index) !== null && _h !== void 0 ? _h : 0;
        message.view = (_j = object.view) !== null && _j !== void 0 ? _j : 0;
        message.function = (_k = object.function) !== null && _k !== void 0 ? _k : 0;
        message.trigger = (_l = object.trigger) !== null && _l !== void 0 ? _l : 0;
        message.type = (_m = object.type) !== null && _m !== void 0 ? _m : 0;
        message.rule = (_o = object.rule) !== null && _o !== void 0 ? _o : 0;
        message.collation = (_p = object.collation) !== null && _p !== void 0 ? _p : 0;
        message.policy = (_q = object.policy) !== null && _q !== void 0 ? _q : 0;
        message.cast = (_r = object.cast) !== null && _r !== void 0 ? _r : 0;
        message.materializedView = (_s = object.materializedView) !== null && _s !== void 0 ? _s : 0;
        return message;
    },
};
