...
export declare const WriteRequest: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["entries"][number], "$type" | "message" | "timestamp" | "level" | "streamName" | "jsonPayload">, never>)[] & Record<Exclude<keyof I["entries"], "$type" | keyof {
            message?: string | undefined;
            timestamp?: Date | undefined;
            level?: import("../../../../yandex/cloud/logging/v1/log_entry").LogLevel_Level | undefined;
            streamName?: string | undefined;
        ...
        } & Record<Exclude<keyof I["defaults"], "$type" | "level" | "streamName" | "jsonPayload">, never>) | undefined;
