...
export declare const LogEntry: {
    ...
    } & Record<Exclude<keyof I, "$type" | "message" | "timestamp" | "uid" | "level" | "streamName" | "resource" | "ingestedAt" | "savedAt" | "jsonPayload">, never>>(object: I): LogEntry;
};
export declare const IncomingLogEntry: {
    ...
    } & Record<Exclude<keyof I, "$type" | "message" | "timestamp" | "level" | "streamName" | "jsonPayload">, never>>(object: I): IncomingLogEntry;
};
export declare const LogEntryDefaults: {
    ...
    } & Record<Exclude<keyof I, "$type" | "level" | "streamName" | "jsonPayload">, never>>(object: I): LogEntryDefaults;
};
